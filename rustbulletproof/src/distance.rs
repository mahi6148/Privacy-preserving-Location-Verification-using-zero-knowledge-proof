...
pub const RADIUS_AT_EQUATOR: f64 = 6_378_137.0;
pub const FLATTENING_ELIPSOID: f64 = 1.0 / 298.257_223_563;
pub const RADIUS_AT_POLES: f64 = (1.0 - FLATTENING_ELIPSOID) * RADIUS_AT_EQUATOR;
pub const MAX_ITERATIONS: u32 = 200;
pub const CONVERGENCE_THRESHOLD: f64 = 0.000_000_000_001;
